...
class MyWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.segundo_acao.setCheckable(True)
        self.segundo_acao.toggled.connect(self.outro_slot)
        self.segundo_acao.hovered.connect(self.outro_slot)

    @Slot()     #esses slots estão fora da função __init__, por isso tava errando bastante.
    def outro_slot(self):
        print('Está marcado?')
